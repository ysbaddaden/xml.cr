...
describe XML::DOM::Element do
  ...
  describe "#insert(before:)" do
    ...
    it "raises when not a child" do
      ...
      node = Element.new("node", document)
      child = Element.new("child", document)
      assert_raises(DOM::Error) { parent.insert(node, before: child) }
    end
  end
  ...
  describe "#insert(after:)" do
    ...
    it "raises when not a child" do
      ...
      node = Element.new("node", document)
      child = Element.new("child", document)
      assert_raises(DOM::Error) { parent.insert(node, after: child) }
    end
  end
  ...
  describe "#remove_child" do
    ...
    it "raises when not a child" do
      node = Element.new("node", document)
      child = Element.new("child", document)
      assert_raises(DOM::Error) { node.remove_child(child) }
    end
  end
end
